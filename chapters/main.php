...
<head>
    ...
    <link rel="stylesheet" href="app/css/main-2d03c6f348.css">
        ...
        <div class="row">
            <div class="head_block">
                <div class="head_header">
                    ...
                    <p class="p wow fadeIn" data-wow-delay=".5s">резюме на позицию html-верстальщик / frontend-разработчик</p>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="content_section">
                <div class="story">
                    Меня зовут <span class="story_name">Вилков Сергей.</span> Я являюсь кандидатом на позицию html-верстальщик/frontend-разработчик.
                ...
                <div class="items_profile">
                    <div class="col-md-6">
                        <ul class="ul_info">
                            ...
                            <li class="li_info"><span>github:</span> <a href="https://github.com/svilkov87">github.com/svilkov87</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="skillbar clearfix " data-percent="60%">
                            <div class="skillbar-title" style="background: #00a8ff;"><span>Java Script/Jquery</span></div>
                            <div class="skillbar-bar" style="background: #00a8ff;"></div>
                            <div class="skill-bar-percent">60%</div>
                        </div>
                        <div class="skillbar clearfix " data-percent="50%">
                            <div class="skillbar-title" style="background: #6a82ff;"><span>PHP (functional style)/ MYSQL</span></div>
